        ...
        <div class="search-fields">
          <div class="cu-search clearfix">
            <div class="form-item form-type-textfield form-item-search-keys">
              ...
              <input placeholder="<?php print $active_configs['placeholder']; ?>" type="search" id="edit-search-keys" name="cse" value="<?php print $query; ?>" size="15" maxlength="1024" class="form-text">
            </div>
