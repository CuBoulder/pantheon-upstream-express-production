...
<script type='text/javascript'>
    ...
    if(
        enableAutoOpen &&
        !(/Android|webOS|iPhone|iPad|iPod|mobile.+firefox|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))
    ) {
...
<?php if ($enable_eye_catcher == 1) : ?>
    <div id="livechat-eye-catcher" style="position: fixed; visibility: visible; z-index: 2147483639; background: transparent; border: 0px; padding: 10px 10px 0px 0px; float: left; margin-right: -10px; backface-visibility: hidden; bottom: 59px; right: 13px;">
        <div onclick="closeimg()" style="position: absolute; display: block; top: -5px; right: -3px; width: 16px; line-height: 16px; text-align: center; cursor: pointer; text-decoration: none; color: rgb(0, 0, 0); font-size: 20px; font-family: Arial, sans-serif; border-radius: 50%; background-color: rgba(255, 255, 255, 0.5);">
                ×
        </div>
        <div id="livechat-eye-catcher-img" style="display: block; overflow: hidden; cursor: pointer;">
            <img id="imagID" alt="Chat now" onclick="closeEyeCatcherAndBootstrap()" src="https://cdn.livechat-files.com/api/file/lc/main/12416433/0/ec/3cd23a1c1292c884141874e90a228a2b.png" style="display: block; border: 0px; float: right; width: 275px; height: 124px;"  />
        </div>
    </div>
<?php endif; ?>